...
<div class="row">
	<div class="title_left col-md-12">
		<h3>Barang Masuk <small>> <a href="{{ url('/barang_masuk/bon_teknik/input') }}" class="text-primary">Input Bon Teknik</a> 	</h3>
	</div>
			...
			<form method="POST" action="inventory_prog.php">
				<div class="form-row mb-4">
					...
					<div class="col-md-12 mb-3">
						...
						<input type="text" class="form-control" id="dilakukan_oleh" placeholder="Dilakukan Oleh" name="dilakukan_oleh" required="">
					</div>

					<div class="col-md-12 mb-3">
						<label for="tgl_terima_bon">Tanggal Terima Bon</label>
						<input type="date" class="form-control" id="tgl_terima_bon" placeholder="date" name="tgl_terima_bon" required="">
					</div>
				</div>
