	...
	<div class="container">
		...
		<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<form method="post" action="{{ route('import_excel_section') }}" enctype="multipart/form-data">
		...
		{{-- <a href="/import/export_excel/section" class="btn btn-success my-3" target="_blank">EXPORT EXCEL</a> --}}

		<table class='table table-bordered'>
			<thead>
				<tr>
					<th>Laptop Device Id</th>
					<th>User</th>
					<th>No Laptop</th>
					<th>Batch</th>
					<th>Departement</th>
