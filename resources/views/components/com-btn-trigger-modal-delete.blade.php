...
<button type="submit" data-toggle="modal" data-target="#deleteModal" data-id="{{ $dataId }}" data-route="{{ route($route . '.destroy', '') }}" class="btn btn-danger btn-sm d-inline">
    <i class="fa fa-trash"></i>
</button>
{{-- <input type="submit" data-toggle="modal" data-target="#deleteModal" data-id="{{ $dataId }}" data-route="{{ route($route . '.destroy', '') }}" class="btn btn-danger btn-sm" value=""> --}}
