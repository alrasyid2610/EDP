...
@php
    ...
    $dataProcessor = [
        'Intel &reg; Core&trade; i7-8700 Processor',
...
<div class="form-computer">
    <div class="row">
        <div class="col-12">
            <h6>Data Hardware <button id="test2" type="button" onclick="test24()">Isi Fill</button></h6>
        </div>
    </div>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][computer_operation]" id="co">
    ...
    <div class="col-md-12 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][pc_brand]" id="brand">
        <option value="">-- Choose --</option>  
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <option value="">-- Choose --</option>
        <option value="Intel &reg; Core&trade; i7-8700 Processor">Intel &reg; Core&trade; i7-8700 Processor</option>
        <option value="Intel &reg; Core&trade; i5-9500 Processor">Intel &reg; Core&trade; i5-9500 Processor</option>
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][operating_system]" id="os">
        <option value="">-- Choose --</option>\
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][internet]" id="internet">
        <option value="">-- Choose --</option>
            @php
    ...
    <div class="col-lg-12 mb-3">
        ...
        <textarea name="dataGoods[goods][{{ $jumlahData }}][computer_description]"  class="form-control" id="description" cols="30" rows="3">{{ $dataComputer[0]->computer_description ?? '' }}</textarea>
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][nsi]" id="nsi">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][boss]" id="boss">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][ms_office]" id="office">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][antivirus]" id="antivirus">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][wsus]" id="wsus">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][click_one]" id="one">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][ax]" id="ax">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][schedule_ppc]" id="ppc">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][ups]" id="ups">
        <option value="">-- Choose --</option>
        @php
    ...
    <div class="col-md-6 mb-3">
        ...
        <select class="custom-select" name="dataGoods[goods][{{ $jumlahData }}][location]" id="loc">
        <option value="">-- Choose --</option>
        @php
