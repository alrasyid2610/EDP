          ...
          <div id="wizard" class="form_wizard wizard_horizontal">
            ...
            <div class="tab-content">
                ...
                @if (isset($route))
                    ...
                    <form class="form-horizontal form-label-left" method="POST" data-action="edit" action="{{ route($route, ['computer' => $dataComputer[0]->id]) }}">
                            @csrf
                            @method('PUT')
                    @else
                ...
                <div id="step-1" class="tab-pane" role="tabpanel">
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="user_login" placeholder="User Logon" name="user_login" required=""
                    ...
                    <div class="col-lg-6 mb-3">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="section" id="section">
                          @php
                            loopSelectDataSection($dataSection, 'section');
                          @endphp
                        </select>
                      </div>
                    </div>
                ...
                <div id="step-4" class="tab-pane" role="tabpanel">
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="custom-select" name="monitor_brand">
                        <option value="">-- Choose --</option>
                        @php
                            loopSelectData(getDataBrandMonitor(), 'monitor_brand');
                        @endphp
                      </select>
                    </div>
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="custom-select" name="screen_plugs">
                        <option value="">-- Choose --</option>
                        @php
                            loopSelectData(getDataScreenPlugs(), 'screen_plugs');
                        @endphp
                      </select>
                    </div>
