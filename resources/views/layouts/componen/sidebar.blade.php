		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					...
					<li><a><i class="fa fa-edit"></i> Barang Masuk <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a>Surat Jalan<span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
									<li class="sub_menu"><a href=" {{ url('/barang_masuk/surat_jalan/create') }} ">Input surat Jalan</a></li>
									<li><a href="{{ url('/barang_masuk/surat_jalan/') }}">View Data</a>
									</li>
								</ul>
							</li>
